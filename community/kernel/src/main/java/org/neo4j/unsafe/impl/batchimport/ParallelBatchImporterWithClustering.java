 ...
 */
public class ParallelBatchImporterWithClustering implements BatchImporter
{
    private static final String INITIAL_STORE_NAME = "initial.db";
    ...
    public ParallelBatchImporterWithClustering( DatabaseLayout directoryStructure, FileSystemAbstraction fileSystem, PageCache externalPageCache,
